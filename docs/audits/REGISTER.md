...
| Tasks workspace | `/work/tasks`, `/work/tasks?view=*` | LOCKED | 1 | `ab61009` | `3d550af` | 6 | — | states: loading/error/desktop-popover NOT-REVIEWED (census-r2 3.2) |
...
| Signals archive | `/work/signals` | LOCKED | 1 | `ab61009` | `3d550af` | 1 | — | states: empty/error/hover NOT-REVIEWED (census-r2 3.5) |
...
| Inbox (deputy triage) | `/inbox` | LOCKED | 1 | `ab61009` | `3d550af` | 2 | — | states: populated-triage/hover/loading/error NOT-REVIEWED — only EMPTY rendered (census-r2 DO-8, F-INBOX-2) |
| Cafe opening home | `/cafe` | LOCKED | 1 | `3d99815` | `3d550af` | 1 | member: capture-only (no review/pushes); ops_lead: sees resolve-queue + rollup | states: started-panel/team-picker/loading/error NOT-REVIEWED — >half the route (census-r2 DO-8) |
| Kitchen sub-tabs (log/plan/stock/review/pushes) | `/cafe/log`, `/cafe/plan`, `/cafe/stock`, `/cafe/review`, `/cafe/pushes` | LOCKED | 1 | `542c48b` | `3d550af` | 1 | member: log/plan/stock only — review + pushes gated (RequireAccessRole ops_lead/admin); ops_lead: all five tabs | persona:member vs ops_lead tab-gating render never audited; review/pushes states NOT-REVIEWED |
