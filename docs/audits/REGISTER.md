...
|---|---|---|---|---|---|---|---|---|
| Home | `/` | LOCKED | 1 | `ab61009` | `7b67d86` | 2 | member: rail shows only viewer-affiliated module (OD-REDESIGN-68); my-work list scoped to own tasks | persona:member (rail-module + my-work scoping never audited); states: hover/loading/error NOT-REVIEWED (census-r2 3.1) |
...
| Signals archive | `/work/signals` | LOCKED | 1 | `ab61009` | `7b67d86` | 1 | — | states: empty/error/hover NOT-REVIEWED (census-r2 3.5) |
...
| Admin — People | `/admin/people` | LOCKED | 1 | `ab61009` | `7b67d86` | 1 | admin: only audience (AdminRoute); finance: no access; ops_lead: no access; member: no access | states: hover/loading/error/empties/menus NOT-REVIEWED (census-r2 3.12) |
