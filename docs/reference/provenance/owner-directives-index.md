...
| P-19 | "kitchen + Bar should be Cafe" | 03 (verbatim; convention audit) | café naming (nav + page titles + body) | owner-word | **SHIPPED at source/test level** — rail, breadcrumbs, page/document titles, body copy, captions, errors, and aria labels use Café/Kafe; `RI-IA-10` preserves internal `Kitchen*` identifiers without leaking the retired noun; fresh rendered three-width proof remains open |
