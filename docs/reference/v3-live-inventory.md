...
| Metric | Count |
| --- | ---: |
| Live route declarations classified | 57 |
| Page routes | 29 |
| Redirect routes | 25 |
| DEV-only routes | 3 |
| CSS files/families scanned | 79 |
| Shared interaction jobs | 13 |
| Jobs with raw/duplicate consumers | 11 |
...
### `/`
- Kind/status/auth: page / canonical / protected
- Component/source: HomePage — `mos-app/src/pages/home-page.tsx` :: `HomePage`; router literal `<index>`
...
- Record opening: default not observed; direct full canonical page when URL is explicit; phone full-screen record mode
- Overlays: centered confirmation/dialog; states: default, error/retry, loading, saving/saved; CSS families: mos-app/src/index.css
- Notes: AdminRoute.
...
- Page family/frame/head: management / shared-page-frame / shared-page-head
- Typography/spacing source: route-local CSS plus shared mos-app/src/index.css; local CSS: mos-app/src/components/catalog/catalog-collection.css
- Collection grammar: route-local collection/view state is present; presentations: —; owns view state: yes
- Record opening: default not observed; direct full canonical page when URL is explicit; phone full-screen record mode
- Overlays: centered search/command candidate; states: default, empty, error/retry, loading, permission/read-only; CSS families: mos-app/src/components/catalog/catalog-collection.css, mos-app/src/index.css
...
- Record opening: default current split/right panel host; direct full canonical page when URL is explicit; phone full-screen record mode
- Overlays: centered search/command candidate, record drawer/panel; states: default, loading; CSS families: mos-app/src/index.css
...
| page-head | mos-app/src/shell/page-head.tsx :: PageHead | — | actions, context, responsive collapse, title |
| record-renderer | mos-app/src/components/signals/signal-record-host.tsx :: SignalRecordHost<br>mos-app/src/components/tasks/task-surface.tsx :: TaskSurface | — | edit, error, read, read-only, saved, saving |
...
| table-or-list | mos-app/src/components/dashboard/data-table.tsx :: DataTable | mos-app/src/components/admin/user-table.tsx :: UserTable<br>mos-app/src/components/inbox/InboxList.tsx :: InboxList<br>mos-app/src/components/signals/signal-feed-presentation.tsx :: SignalFeedPresentation<br>mos-app/src/components/tasks/tasks-workspace.tsx :: TasksWorkspace | default, empty, error, filtered-empty, loading |
...
| --- | --- | --- | --- |
| mos-app/src/components/admin/people-toolbar.css | components | font-size:3, line-height:0, padding:4, margin:0, gap:2, width:8, height:3 | @media (max-width: 767px) |
| mos-app/src/components/assistant/AssistantPanel.css | components | font-size:5, line-height:0, padding:1, margin:0, gap:0, width:5, height:1 | @media (pointer: coarse) |
| mos-app/src/components/cafe/cafe-opening-panel.css | components | font-size:3, line-height:0, padding:0, margin:3, gap:2, width:0, height:0 | — |
| mos-app/src/components/catalog/catalog-collection.css | components | font-size:5, line-height:2, padding:2, margin:2, gap:6, width:6, height:5 | @media (max-width: 480px), @media (pointer: coarse), @media (pointer: coarse) |
| mos-app/src/components/collection-grammar.css | components | font-size:14, line-height:9, padding:8, margin:1, gap:7, width:10, height:18 | @media (prefers-reduced-motion: reduce) |
| mos-app/src/components/command/command-menu.css | components | font-size:7, line-height:0, padding:8, margin:1, gap:3, width:7, height:5 | @media (max-width: 600px), @media (max-width: 767.98px) |
...
| mos-app/src/components/dashboard/global-toolbar.css | components | font-size:1, line-height:0, padding:4, margin:0, gap:3, width:3, height:1 | @media (max-width: 767px) |
| mos-app/src/components/dashboard/kpi-tile.css | components | font-size:6, line-height:1, padding:3, margin:0, gap:3, width:3, height:2 | @media (min-width: 960px), @media (prefers-reduced-motion: reduce) |
...
| mos-app/src/components/home/home-stream.css | components | font-size:9, line-height:0, padding:6, margin:4, gap:12, width:14, height:6 | @media (max-width: 480px) |
| mos-app/src/components/inbox/inbox.css | components | font-size:6, line-height:4, padding:7, margin:3, gap:6, width:4, height:9 | — |
...
| mos-app/src/components/kitchen/kitchen-kpi-strip.css | components | font-size:5, line-height:1, padding:2, margin:1, gap:4, width:9, height:1 | @media (max-width: 959px) and (min-width: 768px) |
...
| mos-app/src/components/kitchen/wip-item-stepper.css | components | font-size:7, line-height:0, padding:4, margin:0, gap:4, width:12, height:2 | — |
...
| mos-app/src/components/processes/due-runs.css | components | font-size:3, line-height:0, padding:4, margin:1, gap:3, width:4, height:1 | @media (prefers-reduced-motion: reduce) |
...
| mos-app/src/components/record-collection/collection-toolbar.css | components | font-size:9, line-height:0, padding:14, margin:1, gap:12, width:28, height:16 | @media (max-width: 767px), @media (prefers-reduced-motion: reduce), @media (prefers-reduced-motion: reduce) |
| mos-app/src/components/record-collection/record-collection.css | components | font-size:5, line-height:2, padding:6, margin:1, gap:5, width:6, height:8 | — |
| mos-app/src/components/records/record-viewer.css | components | font-size:14, line-height:3, padding:8, margin:8, gap:14, width:14, height:18 | @media (max-width: 767.98px), @media (pointer: fine) |
...
| mos-app/src/components/signals/signal-card.css | components | font-size:10, line-height:1, padding:7, margin:1, gap:4, width:7, height:6 | @media (max-width: 480px) |
| mos-app/src/components/signals/signal-composer.css | components | font-size:8, line-height:1, padding:4, margin:1, gap:6, width:6, height:5 | @media (max-width: 767.98px), @media (pointer: coarse) |
| mos-app/src/components/signals/signal-feed-rows.css | components | font-size:6, line-height:0, padding:6, margin:2, gap:7, width:11, height:5 | @media (max-width: 480px) |
| mos-app/src/components/signals/signal-feed-section.css | components | font-size:2, line-height:0, padding:0, margin:1, gap:2, width:2, height:0 | — |
...
| mos-app/src/components/signals/signal-mention-picker.css | components | font-size:4, line-height:0, padding:5, margin:0, gap:1, width:4, height:4 | @media (max-width: 767.98px) |
...
| mos-app/src/components/signals/signal-record.css | components | font-size:14, line-height:1, padding:7, margin:11, gap:9, width:1, height:3 | — |
| mos-app/src/components/signals/signal-table-presentation.css | components | font-size:2, line-height:1, padding:2, margin:0, gap:0, width:12, height:3 | @media (max-width: 1120px) |
...
| mos-app/src/components/tasks/TaskSurface.css | components | font-size:40, line-height:5, padding:34, margin:6, gap:18, width:32, height:38 | @media (max-width: 767.98px), @media (max-width: 767px), @media (max-width: 767px), @media (max-width: 767px), @media (pointer: fine) |
| mos-app/src/components/tasks/TasksWorkspace.css | components | font-size:41, line-height:7, padding:36, margin:5, gap:23, width:56, height:42 | @media (max-width: 1099.98px), @media (max-width: 1120px), @media (max-width: 599.98px), @media (min-width: 1100px), @media (prefers-reduced-motion: reduce), @media (prefers-reduced-motion: reduce), @media (prefers-reduced-motion: reduce) |
...
| mos-app/src/components/ui/DateField.css | components | font-size:2, line-height:0, padding:2, margin:2, gap:2, width:6, height:4 | @media (max-width: 767.98px) |
| mos-app/src/components/ui/IconButton.css | components | font-size:0, line-height:0, padding:1, margin:0, gap:0, width:4, height:3 | @media (max-width: 767.98px) |
...
| mos-app/src/components/ui/Select.css | components | font-size:2, line-height:0, padding:2, margin:0, gap:1, width:4, height:4 | @media (max-width: 767.98px) |
| mos-app/src/components/ui/Tag.css | components | font-size:1, line-height:1, padding:1, margin:0, gap:1, width:1, height:2 | — |
| mos-app/src/components/ui/TextInput.css | components | font-size:2, line-height:0, padding:2, margin:0, gap:2, width:4, height:3 | @media (max-width: 767.98px) |
...
| mos-app/src/pages/budget-page.css | pages | font-size:11, line-height:0, padding:1, margin:3, gap:4, width:4, height:0 | @media (max-width: 767px) |
...
| mos-app/src/pages/dashboard-page.css | pages | font-size:1, line-height:0, padding:9, margin:1, gap:4, width:4, height:2 | @media (max-width: 767px), @media (max-width: 767px), @media (min-width: 1024px), @media (min-width: 1280px) |
...
| mos-app/src/pages/home-page.css | pages | font-size:2, line-height:0, padding:3, margin:0, gap:2, width:0, height:1 | @media (prefers-reduced-motion: reduce) |
...
| mos-app/src/shell/mobile-drawer.css | shell | font-size:0, line-height:0, padding:0, margin:0, gap:0, width:0, height:0 | @media (prefers-reduced-motion: no-preference) |
...
| mos-app/src/shell/page-head.css | shell | font-size:7, line-height:5, padding:1, margin:4, gap:3, width:2, height:6 | @media (max-width: 767.98px) |
| mos-app/src/shell/rail-nav.css | shell | font-size:2, line-height:0, padding:2, margin:0, gap:0, width:1, height:1 | — |
| mos-app/src/shell/record-page-chrome.css | shell | font-size:1, line-height:0, padding:2, margin:0, gap:2, width:4, height:2 | — |
| mos-app/src/shell/record-panel-host.css | shell | font-size:2, line-height:0, padding:2, margin:0, gap:2, width:6, height:3 | @media (pointer: fine), @media (pointer: fine)` |
...
| --- | ---: | --- |
| font-size | 381 | mos-app/src/components/admin/people-toolbar.css, mos-app/src/components/assistant/AssistantPanel.css, mos-app/src/components/cafe/cafe-opening-panel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/chart-frame.css |
| line-height | 54 | mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/dq-badge.css, mos-app/src/components/dashboard/kpi-tile.css, mos-app/src/components/inbox/inbox.css, mos-app/src/components/kitchen/kitchen-kpi-strip.css, mos-app/src/components/kitchen/plan-qty-cell.css |
| padding | 306 | mos-app/src/components/admin/people-toolbar.css, mos-app/src/components/assistant/AssistantPanel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/chart-frame.css, mos-app/src/components/dashboard/cut-toggle.css |
| margin | 90 | mos-app/src/components/cafe/cafe-opening-panel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/chart-frame.css, mos-app/src/components/dashboard/data-table.css, mos-app/src/components/home/home-stream.css, mos-app/src/components/inbox/inbox.css |
| gap | 253 | mos-app/src/components/admin/people-toolbar.css, mos-app/src/components/cafe/cafe-opening-panel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/chart-frame.css, mos-app/src/components/dashboard/cut-toggle.css |
| width | 425 | mos-app/src/components/admin/people-toolbar.css, mos-app/src/components/assistant/AssistantPanel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/chart-frame.css, mos-app/src/components/dashboard/cut-toggle.css |
| height | 329 | mos-app/src/components/admin/people-toolbar.css, mos-app/src/components/assistant/AssistantPanel.css, mos-app/src/components/catalog/catalog-collection.css, mos-app/src/components/collection-grammar.css, mos-app/src/components/command/command-menu.css, mos-app/src/components/dashboard/basis-chip.css, mos-app/src/components/dashboard/chart-frame.css, mos-app/src/components/dashboard/cut-toggle.css |
