...
**Status:** **BINDING for the E7 prototype rebuild.** Every flow / four-lens review scores each rule
...
**Authority:** `CONVERGENCE-AUDIT.md` (the classifications) → `docs/redesign-decision-index.md` →
