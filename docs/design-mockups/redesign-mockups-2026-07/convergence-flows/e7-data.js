...
export const periodEvents = [
  { id:'pe_1', kind:'task',    label:'Task · Finance Team · due 5 Aug', source:'t_bank_recon', when:'2026-08-05' },
  { id:'pe_2', kind:'run',     label:'Process Run · Finance Team · started 3 Aug', source:'run_monthly_close', when:'2026-08-03' },
  { id:'pe_3', kind:'signal',  label:'Signal · Radiant Operations · 10 Jul', source:'sig_vendor', when:'2026-07-10' },
  { id:'pe_4', kind:'exception',label:'Exception · Gordi HQ Operations · 10 Jul', source:'exc_chiller', when:'2026-07-10' },
  { id:'pe_5', kind:'project', label:'Project · Gordi HQ Operations · due 20 Sep', source:'proj_new_menu', when:'2026-07-09' },
];
