 ...
 * reverted.
 *
 * **BOTH surfaces #457 names**, and only which marks each one draws. This is jsdom: no viewport,
...
/** Every link `<RailNav compact />` renders, paired with the mark it draws. */
...
/** Every link the More drawer renders — the phone's only nav to a module's own screens. */
...
// ── the compact rail (`compact` — what 920–1099px passes) ───────────────────────────────────────
...
// ── the phone More drawer (what below-920px passes) ─────────────────────────────────────────────

describe('phone drawer glyphs (issue 457 part 1, the More drawer)', () => {
