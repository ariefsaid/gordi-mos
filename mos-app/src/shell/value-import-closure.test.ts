...
// hand. Three shipped versions of that marker looked complete and were not — a cutover written in
// an unenumerated spelling walked straight past each one — so every spelling that defeated a
// previous version is pinned here, against a throwaway fixture tree, next to the two states that
// must NOT read as a cutover.
//
