// MyWeekPanel — the My Week body, extracted from the MyWeek page (Home v1, Task 4.1,
// ADR-0019 D2 "component survives"/D3). No PageFrame/PageHead here — the page wrapper
// (MyWeek) or the Home composition (HomePage) supplies the frame/head. Behavior is an
// exact clone of the former MyWeek body: MyTasksCard (dominant) + WeeklyUpdateStrip +
// OpsStrip (flag-hidden strips) + TeamModule (manager-conditional).
...
import type { MyUpdate } from '@/lib/db/weekly-updates.types'
import type { TeamMember } from '@/lib/db/weekly-updates'
