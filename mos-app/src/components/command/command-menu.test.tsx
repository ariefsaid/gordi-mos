...
describe('#41: keyboard hints hide on touch (coarse pointer)', () => {
  ...
  // F7: `useIsCoarsePointer` only tests `(pointer: coarse)` — a device that reports a fine
  ...
  it('F7: the stylesheet hides the footer hints under (hover: none), (pointer: coarse) independently of the JS check', () => {
