...
describe('AuthProvider', () => {
  ...
  it('session resolves with a person → status authenticated, viewer.person set', async () => {
    ...
    mockResolveViewer.mockResolvedValue({ person: personRow, roles, isManager: false, accessRoles: [], affiliated: [], hasEmail: true })
  ...
  it('session resolves but resolveViewer returns person null → status orphan', async () => {
    ...
    mockResolveViewer.mockResolvedValue({ person: null, roles: [], isManager: false, accessRoles: [], affiliated: [], hasEmail: true })
