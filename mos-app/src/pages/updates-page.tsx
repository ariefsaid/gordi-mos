...
import { WeeklyUpdateWritePane } from '@/components/weekly/weekly-update-write-pane'
import { WeeklyUpdateReviewPane } from '@/components/weekly/weekly-update-review-pane'
