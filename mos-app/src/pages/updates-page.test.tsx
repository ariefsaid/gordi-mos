...
import type { MyUpdate, TeamUpdateRow } from '@/lib/db/weekly-updates.types'
...
const mockPerson: PeopleRow = {
  ...
  email: 'dina@example.test', archived_at: null,
...
const managerState: AuthState = {
  status: 'authenticated',
  viewer: { person: mockPerson, roles: [mockRole], isManager: true, accessRoles: [] },
  signOut: async () => {},
}
