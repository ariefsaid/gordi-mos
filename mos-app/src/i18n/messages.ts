...
export const messages = {
  en: {
    ...
    'tasks.field.adHoc': "Ad hoc",
    'tasks.field.buPrefix': "BU: ${name}",
    'tasks.field.businessUnit': "Business Unit",
    'tasks.field.createdBy': "Created by",
    'tasks.field.createdByLine': "Created by ${name} · ${date}",
    ...
    'tasks.field.supervisorInherited': "inherited from ${name}",
  ...
  id: {
    ...
    'tasks.field.createdByLine': "Dibuat oleh ${name} · ${date}",
    ...
    'tasks.field.supervisorInherited': "diwarisi dari ${name}",
