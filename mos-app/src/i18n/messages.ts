...
export const messages = {
  en: {
    ...
    'profile.managedByAdmin': 'Managed by Admin — ask an admin to correct these.',
    // Password card: everyone with a real email sees Change password → inline SetPasswordForm;
    // sign-in-name accounts see the "ask your admin" line and no button (viewer.hasEmail, #798).
    'profile.password': 'Password',
    'profile.password.help': 'Change the password you sign in with.',
    'profile.password.change': 'Change password',
    'profile.password.cancel': 'Cancel',
    'profile.password.askAdmin': 'Ask your admin to reset your password.',
    'profile.password.subtitle': 'Choose a new password only you know.',
  ...
  id: {
    ...
    'profile.positions': 'Jabatan',
    'profile.accessLevel': 'Tingkat akses',
    'profile.managedByAdmin': 'Dikelola Admin — hubungi admin untuk memperbaikinya.',
    'profile.password': 'Kata sandi',
    'profile.password.help': 'Ubah kata sandi yang Anda gunakan untuk masuk.',
    'profile.password.change': 'Ubah kata sandi',
    'profile.password.cancel': 'Batal',
    'profile.password.askAdmin': 'Minta admin Anda untuk mengatur ulang kata sandi Anda.',
    'profile.password.subtitle': 'Pilih kata sandi baru yang hanya Anda ketahui.',
