...
export const messages = {
  ...
  id: {
    ...
    'admin.people.empty.org.title': 'Baru Anda sejauh ini',
    ...
    'admin.create.loginHelpOff': 'Nonaktif: hanya entri direktori — akses masuk bisa ditambahkan nanti.',
    ...
    'admin.reveal.copiedAnnounce': 'Kata sandi disalin ke papan klip',
    'admin.reveal.clipboardBlocked': 'Pilih dan salin secara manual — akses papan klip tidak tersedia.',
    ...
    'money.kpi.rev7d.help': 'Jumlah pendapatan bersih selama 7 hari hingga hari pelaporan terbaru. WoW = jendela 7 hari sebelumnya.',
    'money.kpi.rev30d': 'Pendapatan 30 hari terakhir',
    'money.kpi.rev30d.help': 'Jumlah selama 30 hari hingga hari pelaporan terbaru. MoM = jendela 30 hari sebelumnya.',
    ...
    'money.kpi.avgCheck.help': 'Pendapatan jendela berjalan ÷ jumlah transaksi.',
    'money.kpi.channelMix': 'Komposisi kanal',
    'money.kpi.channelMix.sub': 'jendela berjalan',
    'money.kpi.channelMix.help': 'Porsi pendapatan jendela berjalan menurut kanal.',
    'money.kpi.gmPct': 'Marjin kotor %',
    'money.kpi.gmPct.help': 'Marjin kotor ÷ pendapatan selama jendela aktif. Basis = pergerakan stok interim.',
    'money.kpi.gmAmt': 'Nilai marjin kotor',
    'money.kpi.gmAmt.help': 'Pendapatan − HPP interim selama jendela. Delta dibandingkan dengan periode setara sebelumnya.',
    ...
    'money.kpi.bomCoverage.help': 'Porsi HPP yang didasari basis bill-of-materials selama jendela.',
    ...
    'money.table.empty': 'Tidak ada baris untuk potongan ini.',
    ...
    'money.footnote.interim': 'Interim',
    'money.footnote.body': ' = belum direkonsiliasi, hanya POS, pertengahan bulan. HPP diturunkan dari pergerakan stok, ',
    'money.footnote.notCertified': 'belum tersertifikasi GL',
    'money.empty.title': 'Belum ada data snapshot penjualan',
    'money.empty.copy': 'Belum ada baris snapshot penjualan yang tersedia. Snapshot warehouse berikutnya akan mengisi halaman ini.',
    ...
    'money.toolbar.cut': 'Potongan',
    'money.toolbar.cutDimension': 'Dimensi potongan',
    'money.toolbar.timeWindow': 'Jendela waktu',
