...
export const messages = {
  en: {
    ...
    'catalog.objectives.empty.copy': 'Objectives are what the company committed to this period. Open one to see the Projects and Processes working toward it — and, through those, the Tasks. There is no separate cascade screen: you walk the records. Name the first one above.',
    ...
    // Objective record (ticket #813, OD-WAY-97 (2)(5)(7)).
    'objectives.record.loading': 'Loading record',
    'objectives.record.notFound.title': 'Objective not found',
    'objectives.record.notFound.copy': "This record doesn't exist or you don't have access.",
    'objectives.record.error': "Couldn't load this objective.",
    'objectives.record.backToCollection': 'Objectives',
  ...
  id: {
    ...
    'catalog.trace.noParent': 'tanpa Sasaran induk (${count})',
    'catalog.list': 'Daftar',
    ...
    'catalog.objectives.empty.copy': 'Sasaran adalah komitmen perusahaan untuk periode ini. Buka satu Sasaran untuk melihat Proyek dan Proses yang mengarah ke sana — dan lewat itu, Tugas-tugasnya. Tidak ada layar kaskade terpisah: Anda menelusuri lewat catatannya. Beri nama yang pertama di atas.',
    ...
    // Rekord Sasaran (tiket #813, OD-WAY-97 (2)(5)(7)).
    'objectives.record.loading': 'Memuat rekord',
    'objectives.record.notFound.title': 'Sasaran tidak ditemukan',
    'objectives.record.notFound.copy': 'Rekord ini tidak ada atau Anda tidak memiliki akses.',
    'objectives.record.error': 'Tidak dapat memuat Sasaran ini.',
    'objectives.record.backToCollection': 'Sasaran',
