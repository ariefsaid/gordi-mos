...
export const messages = {
  en: {
    ...
    // #808 — new required Team + optional Position + Access chip row; login toggle default rules
    'admin.create.team': 'Team',
    'admin.create.teamPlaceholder': 'Choose a team',
    'admin.create.teamError': 'Choose a team to continue',
    'admin.create.position': 'Position',
    'admin.create.positionHelp': 'Optional — one or more',
    'admin.create.noPositions': 'No positions defined yet',
    'admin.create.access': 'Access',
    'admin.create.loginDisabledReason': 'Add an email or sign-in name first',
    // #808 — Manage <name> dialog, per-row inline save markers, section labels
    'admin.manage.title': 'Manage ${name}',
    'admin.manage.section.teams': 'Teams',
    'admin.manage.section.position': 'Position',
    'admin.manage.section.access': 'Access',
    'admin.manage.section.revenueScope': 'Revenue scope',
    'admin.manage.rowSaved': 'Saved',
    'admin.manage.rowFailed': 'Failed · Retry',
    'admin.people.action.managePerson': 'Manage person',
  ...
  id: {
    ...
    'admin.create.team': 'Tim',
    'admin.create.teamPlaceholder': 'Pilih tim',
    'admin.create.teamError': 'Pilih tim untuk melanjutkan',
    'admin.create.position': 'Jabatan',
    'admin.create.positionHelp': 'Opsional — satu atau lebih',
    'admin.create.noPositions': 'Belum ada jabatan yang ditetapkan',
    'admin.create.access': 'Akses',
    'admin.create.loginDisabledReason': 'Tambahkan email atau nama masuk dulu',
    'admin.manage.title': 'Kelola ${name}',
    'admin.manage.section.teams': 'Tim',
    'admin.manage.section.position': 'Jabatan',
    'admin.manage.section.access': 'Akses',
    'admin.manage.section.revenueScope': 'Cakupan pendapatan',
    'admin.manage.rowSaved': 'Tersimpan',
    'admin.manage.rowFailed': 'Gagal · Coba lagi',
    'admin.people.action.managePerson': 'Kelola orang',
