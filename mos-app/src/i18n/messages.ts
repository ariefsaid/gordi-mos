...
export const messages = {
  en: {
    ...
    // #784 AC-059: the sentence lives here — one home for "Nothing planned yet" (the true
    // empty-state body of the horizon), never doubled on the editor above the summary line.
    'kitchen.plan.pesanan.empty.title': 'Nothing planned yet',
    ...
    'kitchen.plan.seeInLog': 'See these in Log →',
  ...
  id: {
    ...
    'kitchen.plan.seeInLog': 'Lihat di Catatan →',
