...
export const messages = {
  en: {
    ...
    'signals.archive.groupNone': 'None',
    ...
    'signals.archive.searchPlaceholder': 'Search Signals',
    'signals.archive.shareFirst': 'Share the first one',
    ...
    'signals.archive.viewPosted': 'I posted',
    'signals.archive.viewRetracted': 'Retracted',
    'signals.archive.viewsLabel': 'Signal views',
    // #770 AC-031: the eight family names read in the viewer's locale. The DB enum stays English
    // (values above in SIGNAL_CATEGORIES); this catalog is the display key set. Any surface that
    // shows a category — the toolbar filter dropdown, the row's meta line, the archive Feed picker
    // — routes through `signals.category.<slug>` so the two locales never drift.
  ...
  id: {
    ...
    'signals.archive.searchPlaceholder': 'Cari Sinyal',
    'signals.archive.shareFirst': 'Bagikan yang pertama',
    ...
    'signals.archive.viewPosted': 'Saya kirim',
    'signals.archive.viewRetracted': 'Ditarik',
    'signals.archive.viewsLabel': 'Tampilan Sinyal',
    // #770 AC-031: Indonesian family names for the eight Signal categories. Values track the
    // display used across the Café domain and the mockup — one word each where the noun is common
    // and a slash-pair where the family covers two related facts (e.g. Peralatan/fasilitas).
    'signals.category.supplyVendor': 'Pasokan/vendor',
    'signals.category.equipmentFacility': 'Peralatan/fasilitas',
    'signals.category.inventoryAvailability': 'Persediaan/ketersediaan',
