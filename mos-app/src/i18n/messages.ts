...
export const messages = {
  en: {
    ...
    // The document title template. Ported with the Events/Profile surfaces (#199): every page on
    // this branch hard-codes `'X — Gordi MOS'`, which is an English string reaching the tab title
    // of an Indonesian session. Localising it is the point — `dest.events` resolves to "Acara",
    // so the tab must read "Acara — Gordi MOS". Ported surfaces use this; the un-ported ones keep
    // their literal until their own PR.
