...
export const messages = {
  en: {
    ...
    'home.objectives.done': 'done',
    'home.objectives.empty': 'No objectives yet',
    'home.objectives.error': "Couldn't load this list.",
    'home.objectives.retry': 'Retry',
    'home.cafe.title': 'Café',
    'home.cafe.today': 'today',
    'home.cafe.checklist': 'Opening checklist',
    'home.cafe.action': 'Log production',
    'home.cafe.error': "Couldn't load this list.",
    'home.cafe.retry': 'Retry',
    ...
    'tasks.saved.completed': "Completed",
    ...
    'signals.attention.meaning.fyi': 'For information only',
    'signals.attention.meaning.needs-attention': 'Needs a lead to follow up',
    'signals.attention.meaning.urgent': 'Needs attention now',
    ...
    'signals.composer.owningTeamAuthor': 'Owning Team: ${team} · Author: ${name}',
    'signals.composer.justNow': 'Just now',
    'signals.composer.postForbidden': "Couldn't share — you can't post to this team",
    'signals.composer.postFailed': "Couldn't share — try again",
    'signals.composer.discardTitle': 'Discard this Signal?',
    'signals.composer.discardBody': 'Your typed Signal will be lost.',
    'signals.composer.discardConfirm': 'Discard',
    'signals.composer.keepEditing': 'Keep editing',
  ...
  id: {
    ...
    'home.objectives.done': 'selesai',
    'home.objectives.empty': 'Belum ada sasaran',
    'home.objectives.error': 'Daftar ini tidak dapat dimuat.',
    'home.objectives.retry': 'Coba lagi',
    'home.cafe.title': 'Kafe',
    'home.cafe.today': 'hari ini',
    'home.cafe.checklist': 'Daftar pembukaan',
    'home.cafe.action': 'Catat produksi',
    'home.cafe.error': 'Daftar ini tidak dapat dimuat.',
    'home.cafe.retry': 'Coba lagi',
    ...
    'signals.attention.caret': '▾',
    'signals.attention.meaning.fyi': 'Hanya untuk informasi',
    'signals.attention.meaning.needs-attention': 'Perlu ditindaklanjuti oleh pimpinan',
    'signals.attention.meaning.urgent': 'Perlu perhatian sekarang',
    ...
    'signals.composer.owningTeamAuthor': 'Tim Pemilik: ${team} · Penulis: ${name}',
    'signals.composer.justNow': 'Baru saja',
    'signals.composer.postForbidden': 'Tidak dapat membagikan — Anda tidak dapat memposting ke tim ini',
    'signals.composer.postFailed': 'Tidak dapat membagikan — coba lagi',
    'signals.composer.discardTitle': 'Buang Sinyal ini?',
    'signals.composer.discardBody': 'Sinyal yang Anda ketik akan hilang.',
    'signals.composer.discardConfirm': 'Buang',
    'signals.composer.keepEditing': 'Lanjut mengedit',
