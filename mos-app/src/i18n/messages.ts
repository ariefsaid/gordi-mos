...
export const messages = {
  en: {
    ...
    'inbox.emptyCopy': 'Anything addressed to you — mentions, Task naming, Task comments, Urgent Signals in Teams you lead — will appear here.',
    ...
    'inbox.help': 'Everything addressed to you — mentions, Task naming, Task comments, Urgent Signals in Teams you lead — lands here. Opening a row marks it read and takes you to the record it came from. Use Unread to see only what you haven’t looked at yet.',
  ...
  id: {
    ...
    'inbox.emptyCopy': 'Semua yang ditujukan kepada Anda — sebutan, Penamaan Tugas, Komentar Tugas, Sinyal Mendesak di Tim yang Anda pimpin — akan muncul di sini.',
    ...
    'inbox.target.type.followUp': 'AR Follow-up',
    'inbox.help': 'Semua yang ditujukan kepada Anda — sebutan, Penamaan Tugas, Komentar Tugas, Sinyal Mendesak di Tim yang Anda pimpin — muncul di sini. Membuka satu baris menandainya sudah dibaca dan membawa Anda ke catatan asalnya. Pakai filter Belum dibaca untuk melihat yang belum Anda buka saja.',
