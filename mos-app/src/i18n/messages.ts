...
export const messages = {
  en: {
    ...
    'tasks.inlineEdit.hint': "Select a title to edit it · Enter saves · Esc discards · Tab moves",
  ...
  id: {
    ...
    'tasks.inlineEdit.hint': "Pilih judul untuk menyuntingnya · Enter menyimpan · Esc membatalkan · Tab berpindah",
