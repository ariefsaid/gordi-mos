...
export const messages = {
  en: {
    ...
    // Seen ✓ — the shared row chip (#773 / OD-WAY-96 (3, 6)). "Acknowledge" as a verb went with
    // the Acknowledge button; the chip is a private read-state hint, never a lifecycle change.
    'signals.record.seen': 'Seen ✓',
    'signals.record.seenBy': 'Seen by',
    'signals.record.seenByLabel': 'People who have seen this Signal',
  ...
  id: {
    ...
    'signals.record.seenBy': 'Sudah dilihat oleh',
    'signals.record.seenByLabel': 'Orang yang sudah melihat Signal ini',
