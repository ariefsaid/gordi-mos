...
export const messages = {
  en: {
    ...
    'tasks.toolbar.attention': "Attention",
    'tasks.toolbar.clearFilters': "Clear filters",
    'tasks.toolbar.closeFilters': "Close filters",
    'tasks.toolbar.fieldsHelp': "Keep only the metadata that helps you scan this queue.",
    'tasks.toolbar.filters': "Filters",
    'tasks.toolbar.filtersHelp': "Narrow the queue when you need a specific slice of work.",
    'tasks.toolbar.filtersTitle': "Filter this queue",
    'tasks.toolbar.noSavedViews': "No saved views yet.",
    'tasks.toolbar.savedViewsHelp': "Save this queue when you will return to the same slice.",
    'tasks.toolbar.showing': "Showing",
  ...
  id: {
    ...
    'signals.archive.attentionFyi': 'Untuk diketahui',
    ...
    'tasks.toolbar.attention': "Perhatian",
    'tasks.toolbar.clearFilters': "Hapus filter",
    'tasks.toolbar.closeFilters': "Tutup filter",
    'tasks.toolbar.fieldsHelp': "Tampilkan hanya metadata yang membantu Anda memindai antrean ini.",
    'tasks.toolbar.filters': "Filter",
    'tasks.toolbar.filtersHelp': "Persempit antrean saat Anda membutuhkan potongan pekerjaan tertentu.",
    'tasks.toolbar.filtersTitle': "Filter antrean ini",
    'tasks.toolbar.noSavedViews': "Belum ada tampilan tersimpan.",
    'tasks.toolbar.savedViewsHelp': "Simpan antrean ini jika Anda akan kembali ke potongan yang sama.",
    'tasks.toolbar.showing': "Menampilkan",
