...
export const messages = {
  en: {
    'catalog.record.owningTeam': 'Owning Team',
    'catalog.record.teamPerOccurrence': 'Chosen for each occurrence',
    'catalog.record.editChoicesError': 'Could not load edit choices. Try again.',
    'catalog.record.editChoicesLoading': 'Loading edit choices…',
    'signals.archive.attentionFyi': 'FYI',
    'signals.archive.groupUncategorized': 'Uncategorized',
    'signals.category.supplyVendor': 'Supply/vendor',
    'signals.category.equipmentFacility': 'Equipment/facility',
    'signals.category.inventoryAvailability': 'Inventory/availability',
    'signals.category.quality': 'Quality',
    'signals.category.customer': 'Customer',
    'signals.category.people': 'People',
    'signals.category.process': 'Process',
    'signals.category.other': 'Other',
    'catalog.record.periodInvalid': 'Enter a four-digit year.',
    'catalog.view.all': 'All',
    'catalog.includeArchived': 'Include archived',
    'catalog.column.businessUnit': 'Business Unit',
    'catalog.column.accountable': 'Accountable',
    'catalog.column.cadenceDue': 'Cadence · due',
    'catalog.record.readOnly': 'You can view this, but not edit it.',
    'catalog.record.details': 'Details',
    'catalog.record.accessDeniedTitle': 'Project or Process outside your access',
    'catalog.record.accessDeniedBody': 'Your current access does not include this record. Return to the previous record to continue.',
    'catalog.process.notStarted': 'Not started',
    'catalog.process.noSchedule': 'No schedule',
    'catalog.process.onDemand': 'On demand',
    'catalog.process.awaitingAssignment': '${count} awaiting assignment',
    'catalog.process.startedNoTasks': 'Started · no tasks',
    'catalog.record.createTask': 'Create task',
    'catalog.record.noTasks': 'No linked tasks yet.',
    'catalog.record.due': 'Due',
    'catalog.record.dueOffset': 'Day ${count}',
    'catalog.record.responsible': 'Responsible',
    'catalog.record.period': 'Period',
    'catalog.record.tabs.work': 'Work',
    'catalog.record.linkedWork': 'Linked work',
    'catalog.record.tasks': 'Tasks',
    'catalog.record.noRelatedWork': 'No linked Project, Process, or Objective yet.',
    'catalog.record.noRelatedObjective': 'No linked Objective yet.',
    'catalog.record.progress': '${done} / ${total} tasks done',
    'catalog.record.currentNextAction': 'Current and next action',
    'catalog.record.unsaved.title': 'Discard unsaved changes?',
    'catalog.record.unsaved.copy': 'Your rename is not saved. Discard it and leave this record?',
    'catalog.record.unsaved.discard': 'Discard changes',
    'dest.home': 'Home',
    'dest.work': 'Work',
    'dest.inbox': 'Inbox',
    ...
    'home.brief.openTask': 'Open task',
    'home.brief.failedChecksClear': 'No failed checks',
    'home.brief.secondaryLabel': 'Supporting work and signals',
    'home.brief.viewTasks': 'View tasks →',
    'home.brief.reviewChecks': 'Review logs →',
    'home.brief.review': 'Review',
    ...
    'home.stream.band.myWork': 'My open work',
    ...
    'home.stream.allTasks': '${shown} shown · ${count} open →',
    ...
    'home.objectives.drill': 'See all →',
    'home.objectives.progress': '${done}/${total} done →',
    'home.objectives.empty': 'No active Objectives yet.',
    'home.objectives.error': "Couldn't load Objectives.",
    'home.objectives.retry': 'Retry',
    'home.objectives.loading': 'Loading Objectives',
    'home.cafeDoor.heading': 'Café opening',
    'home.cafeDoor.title': 'Café ${branch} · today',
    'home.cafeDoor.progress': 'Opening checklist ${done}/${total}',
    'home.cafeDoor.notStarted': 'Opening checklist · not started',
    'home.cafeDoor.noTasks': 'No opening tasks assigned yet',
    'home.cafeDoor.viewOpening': 'View opening →',
    'home.cafeDoor.logProduction': 'Log production →',
    'home.cafeDoor.empty': 'No Café opening is assigned to your primary stream yet.',
    'home.cafeDoor.error': "Couldn't load today's Café opening.",
    'home.cafeDoor.retry': 'Retry',
    'home.cafeDoor.loading': 'Loading Café opening',
    ...
    'home.region.shown': 'shown',
    'home.region.tablist': 'Home regions',
    'home.day.counts': '${done} handled · ${left} left',
    // The same word Tasks uses for the same idea ("11 open"). "left" named no state and
    // no noun, at the far edge of the greeting row, above the three counts it sums.
    'home.day.left': '${left} open',
    ...
    'profile.homeLayout.help': 'Choose how your Home is arranged. All three layouts keep the information available to you. Signals sits beside your work on desktop and below it on phones.',
    ...
    'inbox.emptyCopy': 'Anything that needs your attention — mentions, task comments, and urgent Signals — will appear here.',
    ...
    'inbox.actorMentioned': '${name} mentioned you',
    'inbox.actorActivity': '${name} commented on a ${entity}',
    'inbox.signalRetraction.title': '${name} retracted your Signal',
    'inbox.signalRetraction.someone': 'Someone',
    'inbox.signalRetraction.reason': 'Reason: ${reason}',
    'inbox.signalRetraction.reasonUnavailable': 'Reason unavailable',
    'inbox.opening': 'Opening…',
    'inbox.updating': 'Updating…',
    ...
    'money.empty.copy': 'No sales snapshot rows are available yet.',
    ...
    'money.window.range': 'Range',
    'money.window.rangeSheet': 'Custom range',
    'money.window.apply': 'Apply',
    'money.window.from': 'From',
    'money.window.to': 'To',
    'money.head.latestReportingDay': 'latest reporting day',
    'money.basis.certified': 'certified',
    'money.basis.interim': 'interim',
    ...
    'access.askAdmin': 'Ask your lead or an admin to give you access.',
    'access.backToHome': 'Back to Home',
    'access.backTo': 'Back to ${area}',
    ...
    'job.objectives': 'Objectives are what your team is working toward this period.',
    'job.profile': 'Your account, language and Home layout.',
    'job.projects': 'Projects and Processes are the work that drives your Objectives.',
    'job.roastery': 'Record today’s roasts, yield, and transfers truthfully.',
    'job.signals': 'Search and revisit the Signals shared across the org.',
    'job.tasks': 'Find and update the work in this view.',
    ...
    'commandMenu.inputPlaceholder': 'Search tasks, signals, people',
    ...
    'cafe.opening.switch.confirmTitle': 'Discard what you have typed?',
    'cafe.opening.switch.confirmBody': 'You have ${count} ${qty} entered for ${from}. Quantities belong to the location they were counted at, so switching to ${to} clears them.',
    'cafe.opening.switch.confirm': 'Discard and switch',
    'cafe.opening.locationStarted': 'Opening in progress',
    'cafe.opening.locationNotStarted': 'Opening available to start',
    'cafe.opening.locationStatusUnknown': 'Status unavailable',
    ...
    'cafe.opening.loadError': "Couldn't load today's café opening. Try again.",
    ...
    'kitchen.streamItems.empty.title': 'No items for ${stream}',
    'kitchen.streamItems.empty.copy': 'This stream has no items on its list yet. An ops lead or admin can add them.',
    'kitchen.item.notOnStream': 'Not on this stream’s list',
    'kitchen.log.error.itemNotOnStream': 'Some items are no longer on this stream’s list. Clear the marked lines or switch stream, then submit again.',
    'kitchen.plan.error.itemNotOnStream': 'This item is no longer on this stream’s list, so it can’t be planned here.',
    'kitchen.log.streamSwitch.confirmTitle': 'Discard entries and switch stream?',
    'kitchen.log.streamSwitch.confirmBody': 'You have ${count} ${qty} entered for ${from}. Quantities belong to the stream they were counted for, so switching to ${to} clears them.',
    'kitchen.log.streamSwitch.confirm': 'Discard and switch',
    ...
    'kitchen.log.summary.aria': 'Plan versus made summary',
    ...
    'kitchen.plan.group.log': 'See these in the Café log →',
    'kitchen.plan.searchPlaceholder': 'Find an item to plan',
    'kitchen.plan.stream.nonProducing': 'This stream receives production; planning production here is unavailable.',
    ...
    'kitchen.pushes.tally.push.one': '${count} push',
    'kitchen.pushes.tally.push.other': '${count} pushes',
    'kitchen.pushes.tally.queued.one': '${count} queued',
    'kitchen.pushes.tally.queued.other': '${count} queued',
    ...
    'kitchen.pushes.empty.copy': 'Nothing has been sent to the outlet system yet.',
    ...
    'assistant.askAbout.taskLabel': "Ask Deputy about this Task",
    'assistant.askAbout.taskHelper': "Deputy will use this record as context",
    ...
    'processes.due.summary.one': "1 run due to start",
    'processes.due.summary.other': "${count} runs due to start",
    'processes.pending.assignCount': "${count} to assign",
    'processes.pending.choose': "Choose PIC",
    'processes.pending.consequence': 'Choosing a person sets the PIC. Supervisor is inherited from the step or Process; if neither specifies one, the chosen PIC is also Supervisor.',
    ...
    'processes.occurrence.title': 'Occurrences',
    'processes.occurrence.loading': 'Loading occurrences',
    'processes.occurrence.error': "Couldn't load process occurrences.",
    'processes.occurrence.authorityError': "Couldn't check occurrence permissions — try again.",
    'processes.occurrence.actionError': "Couldn't update this occurrence — try again.",
    'processes.occurrence.empty': 'No occurrences have been started yet.',
    'processes.occurrence.ready': 'Ready to start',
    'processes.occurrence.nextActionReady': 'Next: start a ready run below.',
    'processes.occurrence.nextActionMissing': 'No current run or ready next run. Check the cadence and owning Team.',
    'processes.occurrence.nextActionCurrent': 'Current runs are listed below. Open their Tasks or resolve pending assignments.',
    'processes.occurrence.setupIncomplete.member': 'Setup incomplete: no active steps are defined. Ask a Process manager to add and activate at least one step before starting a run.',
    'processes.occurrence.setupIncomplete.manager': 'Setup incomplete: no active steps are defined. Open the Steps tab to add and activate at least one step before starting a run.',
    'processes.occurrence.countsLabel': 'Occurrence counts',
    'processes.occurrence.tasks': '${count} tasks',
    'processes.occurrence.overdue': '${count} overdue',
    'processes.occurrence.toAssign': '${count} to assign',
    'processes.occurrence.viewTasks': 'View tasks',
    'processes.occurrence.status.open': 'Open',
    'processes.occurrence.status.completed': 'Completed',
    'processes.occurrence.status.cancelled': 'Cancelled',
    'processes.occurrence.complete': 'Complete occurrence',
    'processes.occurrence.cancel': 'Cancel occurrence',
    'processes.occurrence.completeConfirmTitle': 'Complete this occurrence?',
    'processes.occurrence.completeConfirmCopy': 'Its generated Tasks stay unchanged.',
    'processes.occurrence.cancelConfirmTitle': 'Cancel this occurrence?',
    'processes.occurrence.cancelConfirmCopy': 'Cancellation is recorded for the team and its generated Tasks stay unchanged.',
    'processes.occurrence.cancelReason': 'Reason for cancellation',
    'processes.occurrence.cancelReasonPlaceholder': 'Tell the team why…',
    'processes.occurrence.cancelReasonError': 'Enter a reason to cancel.',
    ...
    'tasks.picOnly': "Only you can be PIC — a supervisor names others",
    ...
    'tasks.create.linkFailed': 'Task created, link failed',
    'tasks.create.linkFailedDiscard': 'Task exists but is unlinked from the Signal.',
    ...
    'tasks.empty.archivedTitle': "Nothing archived yet",
    ...
    'tasks.empty.noTasksCopy': "Everything you or your team own shows up here. PIC is the person doing the work; Supervisor is the person accountable for it. Overdue work is red. Saved views remember what you chose to see so you can come back to the same list — pick one from the chips above.",
    ...
    'tasks.field.createdBy': "Created by",
    ...
    'tasks.filter.attentionAria': "${count} tasks need attention",
    ...
    'tasks.filter.searchPlaceholder': "Search tasks",
    ...
    'tasks.noObjective': "No Objective",
    ...
    'tasks.savedViewsError': 'Saved views are unavailable. Try again.',
    ...
    'catalog.trace.viaTask': '${name} via Tasks (${count})',
    'catalog.list': 'List',
    'catalog.layoutLabel': 'Layout',
    'catalog.viewsLabel': 'View',
    'catalog.view.active': 'Active',
    'catalog.view.archived': 'Archived',
    'catalog.view.activeOnly': 'Active only',
    'catalog.view.activeAndArchived': 'Active + archived',
    'catalog.view.archivedOnly': 'Archived only',
    'catalog.viewAndFilters': 'View & filters',
    'catalog.searchLabel': 'Search by name',
    'catalog.searchPlaceholder': 'Search by name…',
    'catalog.filter.type': 'Type',
    'catalog.filter.status': 'Current status',
    ...
    'catalog.archivedEmpty.title': 'Nothing archived yet',
    ...
    'catalog.coverage.withTasks': 'With tasks',
    'catalog.coverage.noTasks': 'No tasks',
    'catalog.noTasks': 'No tasks yet',
    'catalog.noActivity': 'No activity yet',
    'catalog.notSet': 'Not set',
    ...
    'catalog.column.work': 'Projects & Processes',
    'catalog.column.objective': 'Objective',
    'catalog.column.progress': 'Progress',
    'catalog.column.activity': 'Last activity',
    'catalog.childCount': 'Direct Projects & Processes: ${count}',
    'catalog.record.loading': 'Loading record…',
    'catalog.record.error': 'Couldn’t load this record.',
    'catalog.record.notFound': 'This record is no longer available.',
    'catalog.record.objective': 'Objective',
    'catalog.record.projectProcess': 'Project / Process',
    'catalog.create.project': 'Create project',
    'catalog.create.process': 'Create process',
    'catalog.record.archived': 'Archived',
    'catalog.record.businessUnit': 'Business Unit',
    'catalog.record.businessUnitRequired': 'Choose a Business Unit you manage',
    'catalog.record.accountable': 'Accountable',
    'catalog.record.picTeam': 'PIC Team',
    'catalog.record.supervisorTeam': 'Supervisor Team',
    'catalog.record.cadence': 'Cadence',
    'catalog.record.cadence.manual': 'Manual',
    'catalog.record.cadence.daily': 'Daily',
    'catalog.record.cadence.weekly': 'Weekly',
    'catalog.record.cadence.monthly': 'Monthly',
    'catalog.record.steps': 'Steps',
    'catalog.record.noSteps': 'No active steps defined yet.',
    'catalog.record.tabsLabel': 'Record sections',
    'catalog.record.tabs.details': 'Details',
    'catalog.record.tabs.steps': 'Steps',
    ...
    'catalog.contributionCount': '${count} contributing',
    'catalog.relations.contributesTo': 'Contributes to: ${name}',
    'catalog.relations.viaTask': 'Linked through a Task: ${name}',
    'catalog.relations.alsoContributes': 'Also contributes to: ${names}',
    'catalog.relations.taskContributions': 'Contributes through Tasks to: ${names}',
    ...
    'signals.attention.caret': '▾',
    'signals.attention.meaning.fyi': 'For awareness',
    'signals.attention.meaning.needsAttention': 'Needs a response',
    'signals.attention.meaning.urgent': 'Act now',
    'signals.archive.empty': 'No Signals match "${query}".',
    'signals.archive.emptyUnfiltered': 'No Signals yet.',
    'signals.archive.emptyShareFirst': 'Share the first one',
    ...
    'signals.archive.savedViewsError': 'Saved views are unavailable. Try again.',
    ...
    'signals.archive.viewMine': 'I posted',
    'signals.archive.viewsLabel': 'Signal views',
    'signals.card.openSignal': 'Open signal: ${body}',
    'signals.card.unknownAuthor': 'Someone',
    'signals.composer.contextLabel': 'Signal context',
    'signals.composer.close': 'Close Share Signal',
    'signals.composer.directoryError': 'Could not load people and teams. Retry to continue sharing.',
    'signals.composer.occurredHint': 'WIB',
    'signals.composer.occurredLabel': 'Occurred at',
    'signals.composer.occurredNow': 'Just now',
    'signals.composer.placeholder': 'What happened? Type @ to mention a person, team, or BU.',
    'signals.composer.postError': 'Signal could not be shared. Try again.',
    'signals.composer.addPhoto': 'Add photo',
    'signals.composer.photoCount': 'Photos ${count}/${max}',
    'signals.composer.photosLabel': 'Photos to share',
    'signals.composer.photoAlt': 'Photo ${n} of ${total}',
    'signals.composer.removePhoto': 'Remove photo ${n}',
    'signals.composer.photoError': 'The Signal was shared, but ${count} ${noun} did not upload. Retry, or remove it and finish.',
    'signals.composer.photoNoun': 'photo',
    'signals.composer.photosNoun': 'photos',
    'signals.composer.retryPhotos': 'Retry photos',
    'signals.composer.finish': 'Done',
    'signals.composer.photoFailedAlt': 'Photo ${n} of ${total} — did not upload',
    'signals.record.photosLabel': 'Photos',
    'signals.record.photoAlt': 'Photo ${n} of ${total} — open full size',
    'signals.composer.permissionError': 'You do not have permission to share this Signal.',
    'signals.composer.discardTitle': 'Discard this Signal?',
    'signals.composer.discardBody': 'Your draft will be lost if you leave this composer.',
    ...
    'signals.record.seen': 'Seen',
    'signals.record.seenBy': 'Seen by',
    ...
    'signals.record.createFollowUpTask': 'Create task',
    'signals.record.fromSignal': 'From Signal',
    'signals.record.existingTaskLabel': 'Existing Task',
    'signals.record.existingTaskPlaceholder': 'Choose a Task…',
    'signals.record.factsNote': 'Author and occurrence time are fixed at capture.',
    'signals.record.retractedTitle': 'Retracted Signal',
    ...
    'signals.record.linkedWork': 'Linked work',
    'signals.record.linkedWorkLoading': 'Loading linked work…',
    'signals.record.linkedWorkError': "Couldn't load linked work.",
    'signals.record.mentionsLabel': 'Mentions',
    'signals.record.noLinkableTasks': 'No other Tasks to link yet.',
    'signals.record.moreActions': 'More Signal actions',
    'signals.record.copyLink': 'Copy link',
    ...
    'signals.record.retract': 'Retract',
    'signals.record.retractTitle': 'Retract this Signal?',
    'signals.record.retractBody': 'This Signal will be marked as retracted and can be reposted with corrected provenance.',
    'signals.record.retractReason': 'Reason for retracting',
    'signals.record.retractedBy': 'Retracted by',
    'signals.record.retractorUnknown': 'Not recorded',
    'signals.record.retractedAt': 'Retracted at',
    'signals.record.retractedReason': 'Reason',
    'signals.record.accessDeniedTitle': 'Signal outside your access',
    'signals.record.accessDeniedBody': 'You do not have access to this Signal. Ask a lead if you need it reviewed.',
    'signals.record.missing': 'That Signal no longer exists.',
    'signals.record.actionError': 'That Signal could not be updated. Try again.',
    'signals.record.taskCreatedLinkRetry': 'Task created, but it is not linked to this Signal yet.',
    'signals.record.linkingTask': 'Linking the created Task…',
    'signals.record.retryLink': 'Retry link',
    'signals.record.repost': 'Repost',
    ...
    'admin.people.count.filtered': '${shown} of ${count} people',
    ...
    'admin.people.team.none': 'No team',
    'admin.people.action.manageAccess': 'Manage person',
    ...
    'admin.settings.nav.aria': 'Admin settings sections',
    'admin.settings.nav.people': 'People',
    'admin.settings.nav.teams': 'Teams',
    'admin.settings.nav.access': 'Roles & permissions',
    'admin.access.title': 'Roles & permissions',
    'admin.access.job': 'Set the rules for Work, Signals, and process runs.',
    'admin.access.readCopy': 'Everyone in the organization can read Work. These controls only change write authority.',
    'admin.access.authorityTitle': 'Write authority',
    'admin.access.authorityCopy': 'Everyone receives Member permissions. Other roles add permissions; they never remove a grant from another role.',
    'admin.access.mobileRole': 'Role to edit',
    'admin.access.actionHeader': 'Action',
    'admin.access.tableLabel': 'Role access and authority',
    'admin.access.adminFixed': 'Organization-wide — fixed',
    'admin.access.save': 'Save access rules',
    'admin.access.saving': 'Saving…',
    'admin.access.saved': 'Access rules saved',
    'admin.access.saveError': 'Could not save access rules. Try again.',
    'admin.access.retry': 'Retry access rules',
    'admin.access.loadError': "Couldn't load access rules. Try again.",
    'admin.access.noAccess': 'No additional permission',
    'admin.access.scope.org': 'Organization',
    'admin.access.scope.own_bu': 'Own Business Unit',
    'admin.access.scope.own_team': 'Own Team',
    'admin.access.scope.own': 'Own record',
    'admin.access.action.workline.manage': 'Manage Projects & Processes',
    'admin.access.action.objective.manage': 'Manage Objectives',
    'admin.access.action.signal.post': 'Post Signals',
    'admin.access.action.signal.tag': 'Tag people and Teams in Signals',
    'admin.access.action.signal.retract': 'Retract Signals',
    'admin.access.action.process.start': 'Start process runs',
    'admin.access.action.process.close': 'Close process runs',
    'admin.access.role.team_lead': 'Team lead',
    'admin.access.role.bu_head': 'BU head',
    'admin.access.teamTitle': 'Team leads',
    'admin.access.noLead': 'No designated lead',
    'admin.access.noCandidates': 'No active members in this Team.',
    'admin.access.teamLoadError': "Couldn't load Team members. Try again.",
    'admin.access.teamLoadRetry': 'Retry ${team} members',
    'admin.access.loading': 'Loading access rules',
    'admin.access.teamEmptyTitle': 'No active Teams',
    'admin.access.teamEmptyCopy': 'Add an active Team before designating a lead.',
    ...
    'admin.roles.legend': 'Access for ${name}',
    'admin.person.title': 'Manage ${name}',
    'admin.person.summary': 'Summary',
    'admin.person.access': 'Access',
    'admin.person.teams': 'Teams',
    'admin.person.position': 'Position',
    'admin.person.scope': 'Revenue scope',
    'admin.person.leads': 'Leads',
    'admin.person.noTeams': 'Not on a Team yet',
    'admin.person.home': 'Home',
    'admin.person.homeNote': 'The Home Team sets where Café production opens for them.',
    'admin.person.leadsNone': "Doesn't lead a Team",
    'admin.person.changeLeads': 'Change on Teams',
    'admin.person.canDo': 'What they can do',
    'admin.person.memberBaseline': 'Member baseline',
    'admin.person.via': 'via ${roles}',
    'admin.person.notAllowed': 'Not allowed',
    'admin.person.buHeadNote': "A Business Unit head can get more from their Position; that isn't shown here.",
    'admin.person.canDoError': "Couldn't load what they can do.",
    'admin.person.canDoLoading': 'Loading what they can do…',
    'admin.person.selectedCount': '${count} selected',
    'admin.person.filterLabel': 'Filter ${section}',
    'admin.person.filterPlaceholder': 'Filter…',
    'admin.person.filterEmpty': 'Nothing matches “${q}”.',
    'admin.person.showAll': 'Show all ${count}',
    'admin.teams.helper': 'The Home Team sets where Café production opens — and, for a supervisor, whose production logs they approve.',
    'admin.teams.noHome': 'No Home Team — ${name} has no default Café production stream. Pick one with “Make home”.',
    'admin.teams.makeHome': 'Make home',
    'admin.teams.makeHomeAria': 'Make home — ${team}',
    'admin.teams.none': 'No Teams defined yet',
    'admin.teams.legend': 'Teams for ${name}',
    'admin.position.none': 'No positions defined yet',
    'admin.position.legend': 'Position for ${name}',
    'admin.scope.helper': "Which branches' revenue this person can see",
    'admin.scope.whole': 'Whole ${channel}',
    'admin.scope.none': 'No revenue branches available yet',
    'admin.scope.legend': 'Revenue scope — ${channel} for ${name}',
    'admin.row.saving': 'Saving…',
    'admin.row.saved': 'Saved',
    'admin.row.failed': 'Failed',
    'admin.row.retry': 'Retry',
    'admin.row.retryAria': 'Retry ${item}',
    'admin.roles.confirmGrant.title': 'Make ${name} an Admin?',
    'admin.roles.confirmGrant.body': "Admins add and archive people, change anyone's access and Team leads, and edit the organization's access rules. On Work, Signals and process runs they act organization-wide.",
    'admin.roles.confirmGrant.confirm': 'Make Admin',
    ...
    'admin.teamsPage.col.team': 'Team',
    'admin.teamsPage.col.members': 'Active members',
    'admin.teamsPage.col.lead': 'Lead',
    'admin.teamsPage.members.one': '${count} active member',
    'admin.teamsPage.members.other': '${count} active members',
    'admin.teamsPage.leadLabel': 'Lead for ${team}',
    'admin.teamsPage.loading': 'Loading Teams',
    'admin.teamsPage.loadError': "Couldn't load Teams. Try again.",
    'admin.access.derived.teamLead': 'From Team leadership',
    'admin.access.derived.buHead': 'From Business Unit Position',
    'admin.access.scrollHint': 'More roles → scroll sideways',
    'admin.access.unsaved': 'Unsaved changes',
    'admin.access.leaveMessage': 'Your changes to the access rules are not saved. Leave and discard them?',
    ...
    'kitchen.review.notice.viewPushes': 'View Pushes →',
  ...
  id: {
    ...
    'catalog.record.teamPerOccurrence': 'Dipilih untuk setiap pelaksanaan',
    'catalog.record.editChoicesError': 'Pilihan edit tidak dapat dimuat. Coba lagi.',
    'catalog.record.editChoicesLoading': 'Memuat pilihan edit…',
    'signals.archive.attentionFyi': 'FYI',
    'signals.archive.groupUncategorized': 'Belum dikategorikan',
    'signals.category.supplyVendor': 'Pasokan/pemasok',
    'signals.category.equipmentFacility': 'Peralatan/fasilitas',
    'signals.category.inventoryAvailability': 'Inventaris/ketersediaan',
    'signals.category.quality': 'Kualitas',
    'signals.category.customer': 'Pelanggan',
    'signals.category.people': 'Orang',
    'signals.category.process': 'Proses',
    'signals.category.other': 'Lainnya',
    'catalog.record.periodInvalid': 'Masukkan tahun empat digit.',
    'catalog.view.all': 'Semua',
    'catalog.includeArchived': 'Sertakan arsip',
    'catalog.column.businessUnit': 'Unit Bisnis',
    'catalog.column.accountable': 'Akuntabel',
    'catalog.column.cadenceDue': 'Frekuensi · jatuh tempo',
    'catalog.record.readOnly': 'Anda dapat melihat ini, tetapi tidak dapat menyuntingnya.',
    'catalog.record.details': 'Detail',
    'catalog.record.accessDeniedTitle': 'Proyek atau Proses di luar akses Anda',
    'catalog.record.accessDeniedBody': 'Akses Anda saat ini tidak mencakup catatan ini. Kembali ke catatan sebelumnya untuk melanjutkan.',
    'catalog.process.notStarted': 'Belum dimulai',
    'catalog.process.noSchedule': 'Tanpa jadwal',
    'catalog.process.onDemand': 'Sesuai kebutuhan',
    'catalog.process.awaitingAssignment': '${count} perlu ditetapkan',
    'catalog.process.startedNoTasks': 'Dimulai · belum ada tugas',
    'catalog.record.createTask': 'Buat tugas',
    'catalog.record.noTasks': 'Belum ada tugas yang terhubung.',
    'catalog.record.due': 'Jatuh tempo',
    'catalog.record.dueOffset': 'Hari ke-${count}',
    'catalog.record.responsible': 'Penanggung jawab',
    'catalog.record.period': 'Periode',
    'catalog.record.tabs.work': 'Pekerjaan',
    'catalog.record.linkedWork': 'Pekerjaan terhubung',
    'catalog.record.tasks': 'Tugas',
    'catalog.record.noRelatedWork': 'Belum ada Proyek, Proses, atau Tujuan yang terhubung.',
    'catalog.record.noRelatedObjective': 'Belum ada Tujuan yang terhubung.',
    'catalog.record.progress': '${done} / ${total} tugas selesai',
    'catalog.record.currentNextAction': 'Tindakan saat ini dan berikutnya',
    'catalog.record.unsaved.title': 'Buang perubahan yang belum disimpan?',
    'catalog.record.unsaved.copy': 'Perubahan nama belum disimpan. Buang dan tinggalkan catatan ini?',
    'catalog.record.unsaved.discard': 'Buang perubahan',
    'dest.home': 'Beranda',
    'dest.work': 'Kerja',
    'dest.inbox': 'Inbox',
    ...
    'home.brief.openTask': 'Buka tugas',
    'home.brief.failedChecksClear': 'Tidak ada pemeriksaan gagal',
    'home.brief.secondaryLabel': 'Pekerjaan pendukung dan sinyal',
    'home.brief.viewTasks': 'Lihat tugas →',
    'home.brief.reviewChecks': 'Tinjau log →',
    'home.brief.review': 'Tinjau',
    ...
    'home.stream.band.myWork': 'Pekerjaan aktif saya',
    ...
    'home.stream.allTasks': '${shown} ditampilkan · ${count} terbuka →',
    ...
    'home.objectives.drill': 'Lihat semua →',
    'home.objectives.progress': '${done}/${total} selesai →',
    'home.objectives.empty': 'Belum ada Sasaran aktif.',
    'home.objectives.error': 'Tidak dapat memuat Sasaran.',
    'home.objectives.retry': 'Coba lagi',
    'home.objectives.loading': 'Memuat Sasaran',
    'home.cafeDoor.heading': 'Pembukaan Kafe',
    'home.cafeDoor.title': 'Kafe ${branch} · hari ini',
    'home.cafeDoor.progress': 'Daftar pembukaan ${done}/${total}',
    'home.cafeDoor.notStarted': 'Daftar pembukaan · belum dimulai',
    'home.cafeDoor.noTasks': 'Belum ada tugas pembukaan yang ditugaskan',
    'home.cafeDoor.viewOpening': 'Lihat pembukaan →',
    'home.cafeDoor.logProduction': 'Catat produksi →',
    'home.cafeDoor.empty': 'Belum ada pembukaan Kafe untuk stream utama Anda.',
    'home.cafeDoor.error': 'Tidak dapat memuat pembukaan Kafe hari ini.',
    'home.cafeDoor.retry': 'Coba lagi',
    'home.cafeDoor.loading': 'Memuat pembukaan Kafe',
    ...
    'profile.homeLayout.help': 'Pilih susunan Beranda Anda. Ketiga tata letak tetap menampilkan informasi yang tersedia untuk Anda. Sinyal berada di samping pekerjaan di desktop dan di bawahnya di ponsel.',
    ...
    'inbox.emptyCopy': 'Apa pun yang butuh perhatian Anda — sebutan, komentar tugas, dan Sinyal mendesak — akan muncul di sini.',
    ...
    'inbox.actorMentioned': '${name} menyebut Anda',
    'inbox.actorActivity': '${name} mengomentari ${entity}',
    'inbox.signalRetraction.title': '${name} menarik kembali Sinyal Anda',
    'inbox.signalRetraction.someone': 'Seseorang',
    'inbox.signalRetraction.reason': 'Alasan: ${reason}',
    'inbox.signalRetraction.reasonUnavailable': 'Alasan tidak tersedia',
    'inbox.opening': 'Membuka…',
    'inbox.updating': 'Memperbarui…',
    ...
    'money.empty.copy': 'Belum ada baris pelaporan penjualan.',
    ...
    'money.window.range': 'Rentang',
    'money.window.rangeSheet': 'Rentang khusus',
    'money.window.apply': 'Terapkan',
    'money.window.from': 'Dari',
    'money.window.to': 'Sampai',
    'money.head.latestReportingDay': 'hari pelaporan terbaru',
    'money.basis.certified': 'tersertifikasi',
    'money.basis.interim': 'interim',
    // Kitchen Stock column headers (audit D7 fix)
    'kitchen.stock.col.item': 'Item',
    ...
    'record.moreActions': 'Aksi lainnya',
    ...
    'access.askAdmin': 'Minta atasan atau admin untuk memberi Anda akses.',
    'access.backToHome': 'Kembali ke Beranda',
    'access.backTo': 'Kembali ke ${area}',
    ...
    'job.objectives': 'Objective adalah target yang sedang dikerjakan tim Anda periode ini.',
    'job.profile': 'Akun, bahasa, dan tata letak Beranda Anda.',
    'job.projects': 'Proyek dan Proses adalah kerja yang mendorong Objective Anda.',
    'job.roastery': 'Catat roast hari ini, yield, dan transfer dengan jujur.',
    'job.signals': 'Cari dan tinjau kembali Sinyal yang dibagikan di seluruh organisasi.',
    'job.tasks': 'Temukan dan perbarui pekerjaan di tampilan ini.',
    'job.work': 'Temukan dan kerjakan tugas yang jadi tanggung jawab saya atau Tim saya.',
    'nav.admin.people': 'Orang',
    'nav.admin.teams': 'Tim',
    'nav.admin.roles': 'Peran & izin',
    'nav.cafe': 'Kafe',
    ...
    'commandMenu.inputPlaceholder': 'Cari tugas, sinyal, orang',
    ...
    'cafe.opening.switch.confirmTitle': 'Buang yang sudah kamu isi?',
    'cafe.opening.switch.confirmBody': 'Ada ${count} ${qty} untuk ${from}. Jumlah melekat pada lokasi tempat dihitung, jadi pindah ke ${to} akan menghapusnya.',
    'cafe.opening.switch.confirm': 'Buang dan pindah',
    'cafe.opening.locationStarted': 'Pembukaan sedang berjalan',
    'cafe.opening.locationNotStarted': 'Pembukaan siap dimulai',
    'cafe.opening.locationStatusUnknown': 'Status tidak tersedia',
    ...
    'kitchen.streamItems.empty.title': 'Belum ada item untuk ${stream}',
    'kitchen.streamItems.empty.copy': 'Stream ini belum punya item di daftarnya. Ops lead atau admin bisa menambahkannya.',
    'kitchen.item.notOnStream': 'Tidak ada dalam daftar stream ini',
    'kitchen.log.error.itemNotOnStream': 'Beberapa item sudah tidak ada dalam daftar stream ini. Kosongkan baris yang ditandai atau pindah stream, lalu kirim lagi.',
    'kitchen.plan.error.itemNotOnStream': 'Item ini sudah tidak ada dalam daftar stream ini, jadi tidak bisa direncanakan di sini.',
    'kitchen.log.streamSwitch.confirmTitle': 'Hapus entri dan pindah stream?',
    'kitchen.log.streamSwitch.confirmBody': 'Ada ${count} ${qty} untuk ${from}. Jumlah melekat pada stream tempat dihitung, jadi pindah ke ${to} akan menghapusnya.',
    'kitchen.log.streamSwitch.confirm': 'Hapus dan pindah',
    'kitchen.log.footer.item.one': '${count} item',
    ...
    'kitchen.plan.group.log': 'Lihat di catatan Kafe →',
    'kitchen.plan.searchPlaceholder': 'Cari item rencana',
    'kitchen.plan.stream.nonProducing': 'Tim ini menerima produksi; perencanaan produksi di sini tidak tersedia.',
    ...
    'kitchen.review.leadsOnly': 'Tinjauan tersedia untuk supervisor Tim dan ops lead.',
    'kitchen.review.leadsOnlyMsg': 'Minta supervisor Tim Anda atau ops lead untuk meninjau log yang Anda ajukan.',
    ...
    'kitchen.review.productionPendingErr': 'Produksi Tim ini masih menunggu tinjauan — putuskan dulu sebelum menyetujui transfer.',
    ...
    'kitchen.pushes.tally.push.one': '${count} push',
    'kitchen.pushes.tally.push.other': '${count} push',
    'kitchen.pushes.tally.queued.one': '${count} menunggu',
    ...
    'kitchen.pushes.empty.copy': 'Belum ada yang dikirim ke sistem outlet sejauh ini.',
    ...
    'assistant.askAbout.taskLabel': "Tanya Deputi tentang tugas ini",
    'assistant.askAbout.taskHelper': "Deputi akan menggunakan catatan ini sebagai konteks",
    // #426: Signals gets the same record-scoped Ask Deputy seed as every other record kind.
    ...
    'processes.due.summary.one': "1 run siap dimulai",
    'processes.due.summary.other': "${count} run siap dimulai",
    'processes.pending.assignCount': "${count} perlu ditetapkan",
    'processes.pending.choose': "Pilih PIC",
    'processes.pending.consequence': 'Memilih orang menetapkan PIC. Supervisor mengikuti langkah atau Proses; jika keduanya tidak menentukan Supervisor, PIC yang dipilih juga menjadi Supervisor.',
    ...
    'processes.occurrence.title': 'Kejadian',
    'processes.occurrence.loading': 'Memuat kejadian',
    'processes.occurrence.error': 'Kejadian proses tidak dapat dimuat.',
    'processes.occurrence.authorityError': 'Izin kejadian tidak dapat diperiksa — coba lagi.',
    'processes.occurrence.actionError': 'Kejadian tidak dapat diperbarui — coba lagi.',
    'processes.occurrence.empty': 'Belum ada kejadian yang dimulai.',
    'processes.occurrence.ready': 'Siap dimulai',
    'processes.occurrence.nextActionReady': 'Berikutnya: mulai kejadian yang siap di bawah.',
    'processes.occurrence.nextActionMissing': 'Belum ada kejadian saat ini atau berikutnya yang siap. Periksa frekuensi dan Tim pemilik.',
    'processes.occurrence.nextActionCurrent': 'Kejadian saat ini tercantum di bawah. Buka Tugasnya atau selesaikan penetapan yang tertunda.',
    'processes.occurrence.setupIncomplete.member': 'Penyiapan belum lengkap: belum ada langkah aktif. Minta pengelola Proses menambahkan dan mengaktifkan setidaknya satu langkah sebelum memulai kejadian.',
    'processes.occurrence.setupIncomplete.manager': 'Penyiapan belum lengkap: belum ada langkah aktif. Buka tab Langkah untuk menambahkan dan mengaktifkan setidaknya satu langkah sebelum memulai kejadian.',
    'processes.occurrence.countsLabel': 'Jumlah kejadian',
    'processes.occurrence.tasks': '${count} tugas',
    'processes.occurrence.overdue': '${count} terlambat',
    'processes.occurrence.toAssign': '${count} perlu ditetapkan',
    'processes.occurrence.viewTasks': 'Lihat tugas',
    'processes.occurrence.status.open': 'Terbuka',
    'processes.occurrence.status.completed': 'Selesai',
    'processes.occurrence.status.cancelled': 'Dibatalkan',
    'processes.occurrence.complete': 'Selesaikan kejadian',
    'processes.occurrence.cancel': 'Batalkan kejadian',
    'processes.occurrence.completeConfirmTitle': 'Selesaikan kejadian ini?',
    'processes.occurrence.completeConfirmCopy': 'Tugas yang dibuat tetap tidak berubah.',
    'processes.occurrence.cancelConfirmTitle': 'Batalkan kejadian ini?',
    'processes.occurrence.cancelConfirmCopy': 'Pembatalan dicatat untuk tim dan tugas yang dibuat tetap tidak berubah.',
    'processes.occurrence.cancelReason': 'Alasan pembatalan',
    'processes.occurrence.cancelReasonPlaceholder': 'Jelaskan alasannya kepada tim…',
    'processes.occurrence.cancelReasonError': 'Masukkan alasan pembatalan.',
    ...
    'tasks.picOnly': "Hanya Anda yang dapat menjadi PIC — supervisor menetapkan orang lain",
    ...
    'tasks.create.linkFailed': 'Tugas dibuat, tautan gagal',
    'tasks.create.linkFailedDiscard': 'Tugas ada tetapi belum tertaut ke Sinyal.',
    ...
    'tasks.empty.noTasksCopy': "Semua pekerjaan milik Anda dan tim Anda muncul di sini. PIC adalah orang yang mengerjakan; Supervisor adalah orang yang bertanggung jawab atasnya. Pekerjaan yang lewat tenggat berwarna merah. Tampilan tersimpan mengingat apa yang Anda pilih untuk ditampilkan supaya Anda bisa kembali ke daftar yang sama — pilih dari chip di atas.",
    ...
    'tasks.field.createdBy': "Dibuat oleh",
    ...
    'tasks.adHoc': "Tanpa proyek/proses",
    'tasks.completedAt': "Selesai",
    ...
    'tasks.filter.attentionAria': "${count} tugas memerlukan perhatian",
    ...
    'tasks.savedViewsError': 'Tampilan tersimpan tidak tersedia. Coba lagi.',
    ...
    'catalog.archivedEmpty.title': 'Belum ada yang diarsipkan',
    ...
    'catalog.coverage.withTasks': 'Dengan tugas',
    'catalog.coverage.noTasks': 'Belum ada tugas',
    'catalog.noTasks': 'Belum ada tugas',
    'catalog.noActivity': 'Belum ada aktivitas',
    'catalog.notSet': 'Belum diatur',
    'collection.forbidden.title': 'Kamu tidak punya akses ke koleksi ini',
    'collection.forbidden.copy': 'Tanya admin kalau seharusnya kamu bisa melihatnya.',
    'collection.readOnly': 'Kamu bisa melihat koleksi ini, tapi tidak bisa mengubahnya.',
    'kitchen.log.error.submitFailed': 'Gagal mengirim. Entri Anda masih ada — periksa koneksi lalu coba lagi.',
    'kitchen.log.error.noBusinessUnit': 'Tidak bisa menentukan unit bisnis Café untuk ini. Tanya admin.',
    'catalog.notAvailable': 'Tidak tersedia',
    'catalog.column.name': 'Nama',
    'catalog.column.work': 'Proyek & Proses',
    'catalog.column.objective': 'Tujuan',
    'catalog.column.progress': 'Kemajuan',
    'catalog.column.activity': 'Aktivitas terakhir',
    'catalog.childCount': 'Proyek & Proses langsung: ${count}',
    'catalog.record.loading': 'Memuat catatan…',
    'catalog.record.error': 'Tidak dapat memuat catatan ini.',
    'catalog.record.notFound': 'Catatan ini sudah tidak tersedia.',
    'catalog.record.objective': 'Tujuan',
    'catalog.record.projectProcess': 'Proyek / Proses',
    'catalog.create.project': 'Buat proyek',
    'catalog.create.process': 'Buat proses',
    'catalog.record.archived': 'Diarsipkan',
    'catalog.record.businessUnit': 'Unit Bisnis',
    'catalog.record.businessUnitRequired': 'Pilih Unit Bisnis yang Anda kelola',
    'catalog.record.accountable': 'Akuntabel',
    'catalog.record.picTeam': 'Tim PIC',
    'catalog.record.supervisorTeam': 'Tim Supervisor',
    'catalog.record.cadence': 'Frekuensi',
    'catalog.record.cadence.manual': 'Sesuai kebutuhan',
    'catalog.record.cadence.daily': 'Harian',
    'catalog.record.cadence.weekly': 'Mingguan',
    'catalog.record.cadence.monthly': 'Bulanan',
    'catalog.record.steps': 'Langkah',
    'catalog.record.noSteps': 'Belum ada langkah aktif.',
    'catalog.record.tabsLabel': 'Bagian catatan',
    ...
    'catalog.contributionCount': '${count} kontribusi',
    'catalog.relations.contributesTo': 'Berkontribusi pada: ${name}',
    'catalog.relations.viaTask': 'Terhubung melalui Tugas: ${name}',
    'catalog.relations.alsoContributes': 'Juga berkontribusi pada: ${names}',
    'catalog.relations.taskContributions': 'Berkontribusi melalui Tugas pada: ${names}',
    // The record grammar's in-place save confirmation. Admin People reuses it for the
    // inline "Saved" at a person's row after an in-place edit (GAP-7), so the two never drift.
    ...
    'signals.attention.caret': '▾',
    'signals.attention.meaning.fyi': 'Untuk diketahui',
    'signals.attention.meaning.needsAttention': 'Perlu respons',
    'signals.attention.meaning.urgent': 'Tindak sekarang',
    'signals.archive.empty': 'Tidak ada Sinyal yang cocok dengan "${query}".',
    'signals.archive.emptyUnfiltered': 'Belum ada Sinyal.',
    'signals.archive.emptyShareFirst': 'Bagikan yang pertama',
    ...
    'signals.archive.savedViewsError': 'Tampilan tersimpan tidak tersedia. Coba lagi.',
    ...
    'signals.archive.viewMine': 'Saya posting',
    'signals.archive.viewsLabel': 'Tampilan Sinyal',
    'signals.card.openSignal': 'Buka sinyal: ${body}',
    'signals.card.unknownAuthor': 'Seseorang',
    'signals.composer.contextLabel': 'Konteks Sinyal',
    'signals.composer.close': 'Tutup Bagikan Sinyal',
    'signals.composer.directoryError': 'Gagal memuat orang dan tim. Coba lagi untuk melanjutkan berbagi.',
    'signals.composer.occurredHint': 'WIB',
    'signals.composer.occurredLabel': 'Terjadi pada',
    'signals.composer.occurredNow': 'Baru saja',
    'signals.composer.placeholder': 'Apa yang terjadi? Ketik @ untuk menyebut orang, tim, atau BU.',
    'signals.composer.postError': 'Sinyal tidak dapat dibagikan. Coba lagi.',
    'signals.composer.addPhoto': 'Tambah foto',
    'signals.composer.photoCount': 'Foto ${count}/${max}',
    'signals.composer.photosLabel': 'Foto yang akan dibagikan',
    'signals.composer.photoAlt': 'Foto ${n} dari ${total}',
    'signals.composer.removePhoto': 'Hapus foto ${n}',
    'signals.composer.photoError': 'Sinyal sudah dibagikan, tetapi ${count} ${noun} gagal diunggah. Coba lagi, atau hapus lalu selesaikan.',
    'signals.composer.photoNoun': 'foto',
    'signals.composer.photosNoun': 'foto',
    'signals.composer.retryPhotos': 'Unggah ulang foto',
    'signals.composer.finish': 'Selesai',
    'signals.composer.photoFailedAlt': 'Foto ${n} dari ${total} — gagal diunggah',
    'signals.record.photosLabel': 'Foto',
    'signals.record.photoAlt': 'Foto ${n} dari ${total} — buka ukuran penuh',
    'signals.composer.permissionError': 'Anda tidak memiliki izin untuk membagikan Sinyal ini.',
    'signals.composer.discardTitle': 'Buang Sinyal ini?',
    'signals.composer.discardBody': 'Draf Anda akan hilang jika meninggalkan composer ini.',
    'signals.composer.discard': 'Buang',
    'signals.composer.stay': 'Lanjut mengedit',
    'signals.composer.sendHint': 'Shift+Enter untuk kirim',
    'signals.composer.shareAll': 'Semua tim · ${name}',
    'signals.composer.shareAllNotify': 'Semua tim · memberi tahu ${count} ${noun} · ${name}',
    ...
    'signals.record.seen': 'Sudah dilihat',
    'signals.record.seenBy': 'Dilihat oleh',
    ...
    'signals.record.createFollowUpTask': 'Buat tugas',
    'signals.record.fromSignal': 'Dari Sinyal',
    'signals.record.existingTaskLabel': 'Tugas yang ada',
    'signals.record.existingTaskPlaceholder': 'Pilih Tugas…',
    'signals.record.factsNote': 'Penulis dan waktu kejadian ditetapkan saat pencatatan.',
    'signals.record.retractedTitle': 'Sinyal Ditarik',
    ...
    'signals.record.linkedWork': 'Kerja tertaut',
    'signals.record.linkedWorkLoading': 'Memuat kerja tertaut…',
    'signals.record.linkedWorkError': 'Kerja tertaut tidak dapat dimuat.',
    'signals.record.mentionsLabel': 'Sebutan',
    'signals.record.noLinkableTasks': 'Belum ada Tugas lain untuk ditautkan.',
    'signals.record.moreActions': 'Aksi Sinyal lainnya',
    'signals.record.copyLink': 'Salin tautan',
    ...
    'signals.record.retract': 'Tarik kembali',
    'signals.record.retractTitle': 'Tarik kembali Sinyal ini?',
    'signals.record.retractBody': 'Sinyal ini akan ditandai ditarik kembali dan dapat diposting ulang dengan asal yang diperbaiki.',
    'signals.record.retractReason': 'Alasan penarikan kembali',
    'signals.record.retractedBy': 'Ditarik oleh',
    'signals.record.retractorUnknown': 'Tidak tercatat',
    'signals.record.retractedAt': 'Ditarik pada',
    'signals.record.retractedReason': 'Alasan',
    'signals.record.accessDeniedTitle': 'Sinyal di luar akses Anda',
    'signals.record.accessDeniedBody': 'Anda tidak punya akses ke Sinyal ini. Tanyakan kepada ketua jika perlu ditinjau.',
    'signals.record.missing': 'Sinyal itu sudah tidak ada.',
    'signals.record.actionError': 'Sinyal itu tidak dapat diperbarui. Coba lagi.',
    'signals.record.taskCreatedLinkRetry': 'Tugas sudah dibuat, tetapi belum tertaut ke Sinyal ini.',
    'signals.record.linkingTask': 'Menautkan Tugas yang dibuat…',
    'signals.record.retryLink': 'Coba tautkan lagi',
    'signals.record.repost': 'Posting ulang',
    ...
    'admin.people.count.filtered': '${shown} dari ${count} orang',
    ...
    'admin.people.team.none': 'Tanpa tim',
    'admin.people.action.manageAccess': 'Kelola orang',
    ...
    'admin.settings.nav.aria': 'Bagian pengaturan admin',
    'admin.settings.nav.people': 'Orang',
    'admin.settings.nav.teams': 'Tim',
    'admin.settings.nav.access': 'Peran & izin',
    'admin.access.title': 'Peran & izin',
    'admin.access.job': 'Atur aturan untuk Work, Signals, dan proses.',
    'admin.access.readCopy': 'Semua anggota organisasi dapat membaca Work. Pengaturan ini hanya mengubah kewenangan menulis.',
    'admin.access.authorityTitle': 'Kewenangan menulis',
    'admin.access.authorityCopy': 'Semua orang mendapat izin Anggota. Peran lain menambah izin, tanpa mencabut izin dari peran lainnya.',
    'admin.access.mobileRole': 'Peran yang diubah',
    'admin.access.actionHeader': 'Tindakan',
    'admin.access.tableLabel': 'Akses dan kewenangan peran',
    'admin.access.adminFixed': 'Tingkat organisasi — tetap',
    'admin.access.save': 'Simpan aturan akses',
    'admin.access.saving': 'Menyimpan…',
    'admin.access.saved': 'Aturan akses tersimpan',
    'admin.access.saveError': 'Aturan akses gagal disimpan. Coba lagi.',
    'admin.access.retry': 'Coba lagi aturan akses',
    'admin.access.loadError': 'Gagal memuat aturan akses. Coba lagi.',
    'admin.access.noAccess': 'Tidak ada izin tambahan',
    'admin.access.scope.org': 'Organisasi',
    'admin.access.scope.own_bu': 'Business Unit sendiri',
    'admin.access.scope.own_team': 'Tim sendiri',
    'admin.access.scope.own': 'Catatan sendiri',
    'admin.access.action.workline.manage': 'Kelola Projects & Processes',
    'admin.access.action.objective.manage': 'Kelola Objectives',
    'admin.access.action.signal.post': 'Kirim Signals',
    'admin.access.action.signal.tag': 'Tag orang dan Tim di Signals',
    'admin.access.action.signal.retract': 'Tarik kembali Signals',
    'admin.access.action.process.start': 'Mulai proses',
    'admin.access.action.process.close': 'Tutup proses',
    'admin.access.role.team_lead': 'Ketua tim',
    'admin.access.role.bu_head': 'Kepala BU',
    'admin.access.teamTitle': 'Ketua tim',
    'admin.access.noLead': 'Belum ada ketua',
    'admin.access.noCandidates': 'Tidak ada anggota aktif di Tim ini.',
    'admin.access.teamLoadError': 'Gagal memuat anggota Tim. Coba lagi.',
    'admin.access.teamLoadRetry': 'Coba lagi anggota ${team}',
    'admin.access.loading': 'Memuat aturan akses',
    'admin.access.teamEmptyTitle': 'Belum ada Tim aktif',
    'admin.access.teamEmptyCopy': 'Tambahkan Tim aktif sebelum menunjuk ketua.',
    ...
    'admin.roles.legend': 'Akses untuk ${name}',
    'admin.person.title': 'Kelola ${name}',
    'admin.person.summary': 'Ringkasan',
    'admin.person.access': 'Akses',
    'admin.person.teams': 'Tim',
    'admin.person.position': 'Jabatan',
    'admin.person.scope': 'Cakupan pendapatan',
    ...
    'admin.person.memberBaseline': 'Dasar Anggota',
    'admin.person.via': 'lewat ${roles}',
    'admin.person.notAllowed': 'Tidak diizinkan',
    'admin.person.buHeadNote': 'Kepala Business Unit bisa mendapat lebih dari Jabatannya; itu tidak ditampilkan di sini.',
    'admin.person.canDoError': 'Gagal memuat yang bisa dilakukan.',
    'admin.person.canDoLoading': 'Memuat yang bisa dilakukan…',
    'admin.person.selectedCount': '${count} dipilih',
    'admin.person.filterLabel': 'Saring ${section}',
    ...
    'admin.teams.legend': 'Tim untuk ${name}',
    'admin.position.none': 'Belum ada jabatan',
    'admin.position.legend': 'Jabatan untuk ${name}',
    'admin.scope.helper': 'Cabang mana yang pendapatannya bisa dilihat orang ini',
    'admin.scope.whole': 'Seluruh ${channel}',
    'admin.scope.none': 'Belum ada cabang pendapatan',
    'admin.scope.legend': 'Cakupan pendapatan — ${channel} untuk ${name}',
    'admin.row.saving': 'Menyimpan…',
    'admin.row.saved': 'Tersimpan',
    'admin.row.failed': 'Gagal',
    'admin.row.retry': 'Coba lagi',
    'admin.row.retryAria': 'Coba lagi ${item}',
    'admin.roles.confirmGrant.title': 'Jadikan ${name} Admin?',
    'admin.roles.confirmGrant.body': 'Admin menambah dan mengarsipkan orang, mengubah akses dan ketua Tim siapa pun, serta mengubah aturan akses organisasi. Di Work, Signals, dan proses mereka bertindak di seluruh organisasi.',
    'admin.roles.confirmGrant.confirm': 'Jadikan Admin',
    ...
    'admin.teamsPage.col.team': 'Tim',
    'admin.teamsPage.col.members': 'Anggota aktif',
    'admin.teamsPage.col.lead': 'Ketua',
    'admin.teamsPage.members.one': '${count} anggota aktif',
    'admin.teamsPage.members.other': '${count} anggota aktif',
    'admin.teamsPage.leadLabel': 'Ketua untuk ${team}',
    'admin.teamsPage.loading': 'Memuat Tim',
    'admin.teamsPage.loadError': 'Gagal memuat Tim. Coba lagi.',
    'admin.access.derived.teamLead': 'Dari kepemimpinan Tim',
    'admin.access.derived.buHead': 'Dari Jabatan Business Unit',
    'admin.access.scrollHint': 'Peran lain → geser ke samping',
    'admin.access.unsaved': 'Belum disimpan',
    'admin.access.leaveMessage': 'Perubahan aturan akses belum disimpan. Keluar dan buang perubahan?',
    ...
    'kitchen.review.notice.viewPushes': 'Lihat Pushes →',
