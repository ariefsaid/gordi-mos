...
export const messages = {
  en: {
    ...
    'kitchen.plan.help': 'Type the portions you plan for each dish today. Every change saves itself as soon as you leave the field — there is no submit button. Pick another branch or activity to plan that stream; each stream keeps its own plan.',
    ...
    'kitchen.plan.pesanan.searchPlaceholder': 'Find a dish in the plan',
    'kitchen.plan.pesanan.toolbarAria': 'Order plan filters',
    'kitchen.plan.row.logAria': 'See ${dish} in the Café log',
    ...
    'kitchen.plan.summary.dishesPlanned': 'Dishes planned',
  ...
  id: {
    ...
    'kitchen.plan.help': 'Ketik porsi yang Anda rencanakan untuk tiap menu hari ini. Setiap perubahan tersimpan sendiri begitu Anda keluar dari kolomnya — tidak ada tombol kirim. Pilih cabang atau aktivitas lain untuk merencanakan aliran itu; tiap aliran menyimpan rencananya sendiri.',
    ...
    'kitchen.plan.pesanan.searchPlaceholder': 'Cari menu dalam rencana',
    'kitchen.plan.pesanan.toolbarAria': 'Filter rencana pesanan',
    'kitchen.plan.row.logAria': 'Lihat ${dish} di catatan Kafe',
    ...
    'kitchen.plan.summary.dishesPlanned': 'Menu direncanakan',
