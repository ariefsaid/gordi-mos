...
export const messages = {
  en: {
    ...
    'tasks.inlineEdit.hint': "Select a title to edit it · Enter saves · Tab moves · Esc discards",
  ...
  id: {
    ...
    'tasks.inlineEdit.hint': "Pilih judul untuk menyuntingnya · Enter menyimpan · Tab berpindah · Esc membatalkan",
