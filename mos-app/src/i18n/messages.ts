...
export const messages = {
  en: {
    ...
    // Also Admin People's (#201) in-place save confirmation — it reuses this key for the inline
    // "Saved" at a person's row after an in-place edit (GAP-7), so the two never drift.
