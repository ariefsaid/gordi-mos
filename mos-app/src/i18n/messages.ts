...
export const messages = {
  en: {
    ...
    'signals.composer.photoError': 'The Signal was shared, but ${count} photo did not upload. Check your connection and retry.',
  ...
  id: {
    ...
    'signals.composer.photoError': 'Sinyal sudah dibagikan, tetapi ${count} foto gagal diunggah. Periksa koneksi lalu coba lagi.',
