...
if [ "$SEED" = "1" ]; then
  say "Applying seeds (seed.sql, seed.dev-tasks.sql, seed.dev-signals.sql, seed.dev-processes.sql, seed.dev-cafe-opening.sql, seed.dev-auth.sql)"
  for f in seed.sql seed.dev-tasks.sql seed.dev-signals.sql seed.dev-processes.sql seed.dev-cafe-opening.sql seed.dev-auth.sql; do
