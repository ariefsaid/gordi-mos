...
echo "  pre-commit gates: conflict markers + unverifiable claims + eslint/stylelint/vitest, staged only"
echo "  commit-msg gates: a message that counts its own evidence (scripts/claim-check.sh)"
