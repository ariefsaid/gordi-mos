...
async function detectCli() {
  ...
  // A browser dependency/navigation failure is not a clean design result. Earlier versions
  // printed the error and then emitted [] with exit code 0, allowing automation to record a
  // rendered pass that never ran.
  if (scanFailed) process.exit(1);
