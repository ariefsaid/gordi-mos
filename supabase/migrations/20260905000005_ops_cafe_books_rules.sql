-- Café books rule correction (#777).
...
alter table shared.teams add constraint teams_produces_pair_check
  check ((branch_id is null) = (produces is null));
...
begin
  ...
  insert into ops.kitchen_logs
    ...
    ('00000000-0000-0000-0000-00000000ac05','00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-00000000bb01','2026-06-20','00000000-0000-0000-0000-00000000bf02','kitchen','transfer','00000000-0000-0000-0000-00000000bf03','00000000-0000-0000-0000-00000000ab01',3,'Submitted','00000000-0000-0000-0000-0000000000d1'),
...
-- create function shared._set_team_produces_default()
-- returns trigger language plpgsql set search_path = '' as $$
-- begin
