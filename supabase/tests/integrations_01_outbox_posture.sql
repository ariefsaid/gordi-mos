...
insert into shared.branches (id, org_id, code, name) values
  ...
  ('00000000-0000-0000-0000-00000000bf03','00000000-0000-0000-0000-0000000000a1','radiant','Radiant') on conflict (id) do nothing;
...
select is(
  ...
  array['esb_push_groups_select_ops_lead_or_admin:SELECT','esb_push_select_ops_lead_admin_or_retail_ops_manager:SELECT']::text[],
